...
class Line(object):
    ...
    def slope(self):
        ...
        if self.start.x == self.end.x:
            ...
            x = ((self.end.y-self.start.y)/(self.end.x-self.start.x))
            return x
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        x = self.start.plus(other_line.start)
        y = self.end.plus(other_line.end)
        return Line(x,y)
    ...
    def line_minus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        x = self.start.minus(other_line.start)
        y = self.end.minus(other_line.end)
        return Line(x,y)
