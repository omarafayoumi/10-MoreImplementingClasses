    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        self.v_rect = rg.Rectangle(rg.Point(intersection_center.x - (letter_thickness/2), intersection_center.y + height - (letter_thickness/2)),
    ...
    def clone(self):
        ...
        #######################################################################
        cloon = CapitalT(self.h_rect.get_center(),self.h_rect.get_width(),self.v_rect.get_height(),self.v_rect.get_width())
        cloon.set_colors(self.v_rect.fill_color,self.v_rect.outline_color)
        return cloon
